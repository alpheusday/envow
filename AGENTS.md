...
Envow is a vow-driven env validation library to work with TypeScript.

It validates the runtime environment against a Standard Schema dictionary
and returns a read-only, typed object.
